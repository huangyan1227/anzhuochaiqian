...
public class MyXinWenAdapter extends BaseAdapter {
    ...
    public MyXinWenAdapter(List<Map<String,Object>> shuJuXianQingsList,Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MyXinWenAdapter.ViewHolder holder=null;

        if (convertView==null){


            holder = new MyXinWenAdapter.ViewHolder();

            convertView = inflater.inflate(R.layout.layout_xinwen_item,null);


            holder.image_photo = (ImageView) convertView.findViewById(R.id.xinwenimage_photo);
            holder.tv_name = (TextView) convertView.findViewById(R.id.xinwentitle);
          //  holder.tv_age = (TextView) convertView.findViewById(R.id.xinwenregional);

            holder.tvTele =(TextView) convertView.findViewById(R.id.xinwentell);
...
//        ShuJuXianQing shuJuXianQing = (ShuJuXianQing) getItem(position);
            ...
            holder = (MyXinWenAdapter.ViewHolder) convertView.getTag();
        }
